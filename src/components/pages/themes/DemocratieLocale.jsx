  ...
  return (
    <article className="theme-page">
      ...
      <div className="theme-content">
        <p>
          <span>Depuis douze ans, Frédéric Chéreau a fait de la “démocratie participative” un
...
d’aménagement local
        ...
        <br></br>
          ...
          <li>
           ➔ <span><span className="theme-bold">Donner</span> un droit de motion aux Assemblées de quartier pour inscrire un sujet
...
dates (faisable dès la première année)
        ...
        <br></br>
          ...
          <li>
           ➔ <span><span className="theme-bold">Tripler</span> le budget participatif pour atteindre 300 000€ par an, dont une part
